...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Create Website'])
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="store_name" name="store_name" class="form-control" placeholder="Enter Website Name Without Space">
                            </div>
