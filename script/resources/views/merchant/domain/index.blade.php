...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Manage Website'])
@endsection
		...
		<div class="card">
			...
			<div class="card-body">
				<!--div class="d-flex align-items-center justify-content-between mb-3">
					<h5>{{ __('Manage Website') }}</h5>
					<div class="section-header-button">
						<a href="{{ route('merchant.domain.create') }}" class="btn btn-primary btn-lg">Add Website</a>
					</div>
				</div-->
				<div class="Website-section">
					<div class="table-responsive">
						<table class="Website_all table table-hover">
							<thead>
								<tr>
									...
									<td>
										...
										<div class="dropdown d-inline">
											...
											<div class="dropdown-menu">
												<!--<a class="dropdown-item has-icon" href="{{ route('merchant.domain.edit',$row->id) }}"><i class="fas fa-Website-alt"></i> {{ __('Edit Website') }}</a>
